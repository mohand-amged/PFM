...
function Form() {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
                <label className="block text-sm font-medium text-white">Subscription Name</label>
                <input
                    {...register("name", { required: true })}
                    className="mt-1 block w-full border border-border rounded-md shadow-sm p-2 bg-background text-white"
            ...
            <div>
                <label className="block text-sm font-medium text-white">Billing Cycle</label>
                <select
